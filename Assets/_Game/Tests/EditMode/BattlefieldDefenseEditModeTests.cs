...
namespace Stonehold.Tests
{
    public class BattlefieldDefenseEditModeTests
    {
        ...
        [Test] public void ProductionCards_RemainThirtyNine() { Assert.That(AssetDatabase.FindAssets("t:CardDefinition", new[] { "Assets/_Game/Resources/Cards" }).Length, Is.EqualTo(49)); }
